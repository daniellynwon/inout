...
<!-- 
		...
		<input type="submit" value="채용 공고 등록" id="btn_next" class="btn btn-primary btn-lg" style="border: none; background-color: white; margin: 0 auto; width:100%; "/>
		</form>
	</div>
