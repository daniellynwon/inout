					...
					<div class="are_data"> 
						<div class="row">
							...
							<div class="optional_item" id="term" >
								<dl id="probation_term_wrap" style="margin-top: 370px; margin-left: 150px;">
									
									<div style="background-color: gray;">
										 <input type="text" class="inpTypo sizeS _filter"
											id="probation_term" data-filter="numeric" maxlength="2"
											title="수습기간 입력" style=" float: left;"><span style="float: left; margin-left: 20px;">개월</span>
									</div>
								</dl>
								<dl id="contract_term_wrap" style="margin-top: 370px; margin-left: 40px;"/>
									...
									<dd>
										<span style="font-family: 나눔스퀘어;">계약기간</span> <input type="text" class="inpTypo sizeS _filter"
											...
											<span class="inpChk"><input type="checkbox"
												...
												for="chk_term_jt_10" style="margin-left: 20px;">정규직 전환 가능</label></span> <span class="inpChk"><input
