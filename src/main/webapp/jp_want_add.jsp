...
<body>
	...
	<div class="step_recruit" id="frmDivision" style="float: left; padding-bottom: 50px;">
		<div class="frm_header">
			<h2 class="tit_step">모집분야 추가하기</h2>
		...
		<button type="button" id="btn_add" class="btn btn-primary btn-lg" style="border: none; background-color: white; margin: 0 auto; width:100%; "> 추가하기 </button>
