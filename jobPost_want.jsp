...
<script type="text/javascript">
	$(function(){
		...
		$('#lpop_essential_preference2').hide();
		$('#lpop_essential_preference3').hide();
		$('#lpop_essential_preference4').hide();
		$('#lpop_essential_preference5').hide();
		...
		/* 필수 우대조건 추가하기 버튼 */
		$('#btn_choose1').click(function(){
			$('#lpop_essential_preference1').toggle();
		});
		$('#btn_choose2').click(function(){
			$('#lpop_essential_preference2').toggle();
		});
		$('#btn_choose3').click(function(){
			$('#lpop_essential_preference3').toggle();
		});
		$('#btn_choose4').click(function(){
			$('#lpop_essential_preference4').toggle();
		});
		$('#btn_choose5').click(function(){
			$('#lpop_essential_preference5').toggle();
		});
