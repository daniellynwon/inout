		...
		<div class="frm_body frm_template">
			...
			<div class="items" id="insatong">
				...
				<div class="area_tit" style="padding-left: 10px;">
					<strong class="tit">인사통 수정하기</strong>
				</div>
			...
			<button type="button" id="btn_edit" class="btn btn-primary btn-lg" style="border: none; background-color: white; margin: 0 auto; width:100%; "> 인사통 수정 완료</button>
