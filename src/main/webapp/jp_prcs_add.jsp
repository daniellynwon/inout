...
<body>
	...
	<div class="step_recruit" id="frm_hiring">
		<div class="frm_header">
			<h2 class="tit_step">채용절차 추가하기</h2>
...
<!-- 
		...
		<input type="submit" value="추가완료" id="btn_add" class="btn btn-primary btn-lg" style="border: none; background-color: white; margin: 0 auto; width:100%; "/>
		</form>
	</div>
